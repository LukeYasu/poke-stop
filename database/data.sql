...
values ('Pokeball', 100, 'pokeball.png', 'An essential part of any trainers bag. Helps you effectively catch pokémon.', 1, 1000),
       ...
       ('Pokeball 10 Pack', 900, 'pokeball.png','An essential part of any trainers bag. Helps you effectively catch pokémon.', 10, 1000),
       ...
       ('Level Ball', 1000, 'levelball.png', 'A Pokeball that allows you to increase your chances of capturing pokemon dependant on the levels of both your Pokémon and the opponent Pokémon.', 1,1000),
       ...
       ('Potion', 200, 'potion.png', 'This potion heals 20hp and is an essential part of any trainers journey to ensure that their pokemon stay safe and strong for whatever explorations you and your Pokémon embark on.', 1,1000),
       ('Super Potion', 400, 'superpotion.png', 'This potion heals 50hp and is an essential part of any trainers journey to ensure that their pokemon stay safe and strong for whatever explorations you and your Pokémon embark on.', 1,1000),
       ('Max Potion', 2500, 'maxpotion.png', 'This potion heals to full HP and is an essential part of any trainers journey to ensure that their pokemon stay safe and strong for whatever explorations you and your Pokémon embark on.', 1,1000),
